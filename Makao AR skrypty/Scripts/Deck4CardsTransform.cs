...
using TMPro;
public class Deck4CardsTransform : MonoBehaviour
{
    // Animator _animator;
    ...
    #region Zamiana kart       
        ...
        if (Deck1.transform.GetChild(6).GetComponent<BoxCollider>().enabled == true)
        {
            ...
            for (int i = 0; i < 7; i++)
            {
                Deck4.transform.GetChild(i).GetComponent<BoxCollider>().enabled = false;
                HelpState.text = "Kolejka gracza 1";
            }
            Deck4.GetComponent<Deck4CardsTransform>().enabled = false;
            Deck4.GetComponent<CheckCards4>().enabled = false; 
        } 
    #endregion
    #endregion                 
    ...
    #region Zamiana kart            
        ...
        if (Deck2.transform.GetChild(6).GetComponent<BoxCollider>().enabled == true)
        {
            ...
            {
                Deck4.transform.GetChild(i).GetComponent<BoxCollider>().enabled = false;
                HelpState.text = "Kolejka gracza 2, gracz 1 zostaje pominięty";
            }
            Deck4.GetComponent<Deck4CardsTransform>().enabled = false; 
...
void Update()
    {
        if (Input.touchCount == 1 && Input.touches[0].phase == TouchPhase.Ended)
        {
            ...
            if (Physics.Raycast(raycast, out raycastHit))
            {
                ...
                for (int i=0; i<7;i++){
                    Deck4.transform.GetChild(i).GetComponent<GetDeckCardValue>().enabled = true;
                }
